...
export default class section_1 extends Component {
  ...
  monRightClick() {
    ...
    this.refDateSpan.current.innerText = `Nous sommes: ${
      this.DayName
      ...
      <div id="bigDiv">
        <div id="petiteDiv1">
          ...
          <h2 ref={this.refDateSpan} id="mydatte">
            Aujourd'hui: {this.DayName} {this.maDate.getDay() + 4}-
            {this.maDate.getMonth() + 1}-{this.maDate.getFullYear()}
          </h2>
        </div>

        <div id="petiteDiv2">
          <button
            onClick={this.monCalendrier}
            type="button"
            class="btn btn-outline-dark"
          >
